...
import cta_thumb from "/public/ico/assets/img/update/bg/cta-2-shape1.png"
   ...
   return (
      ...
      <div className="pt-140 pb-140 position-relative z-index-common">
         ...
         <div className="container">
            <div className="cta-wrap2 pt-140 pb-140" style={{ backgroundImage: `url(/public/ico/assets/img/update/bg/cta-2-bg.png)`, backgroundSize: "cover" }}>
