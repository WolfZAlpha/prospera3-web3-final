...
import footerShape_1 from "/public/ico/assets/img/images/footer_shape01.png";
import footerShape_2 from "/public/ico/assets/img/images/footer_shape02.png";
...
const FooterThree = () => {
   return (
      <footer>
         <div className="footer-area footer-bg" style={{ backgroundImage: `url(/public/ico//assets/img/bg/footer_bg.png)` }}>
